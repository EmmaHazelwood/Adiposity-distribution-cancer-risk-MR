...
exposure_dat<-rbind(exposure_dat1,exposure_dat2,exposure_dat3,exposure_dat4,exposure_dat5)
...
fwrite(results,"results/LiverFatMR/Adiposity_measures_obesity_cancers_results_new_proxies.csv")
